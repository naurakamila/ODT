...
from .views import form_in, in_view, form_out, out_view, delete_view, delete_view2
urlpatterns = [
    ############### Components ###############
    path('form-pemasukan', form_in, name='form_in'),
    path('tabel-pengeluaran', out_view, name='out'),
    path('tabel-pemasukan', in_view, name='in'),
    path('form-pengeluaran', form_out, name='form_out'),
    path('delete/<int:item_id>', delete_view2, name='delete2'),
    ...
    # Tables
    path('tabel_pengeluaran', views.Basic.as_view(),name='tables_basic'),
    path('tabel_pemasukan', views.Datatable.as_view(),name='tables_datatable'),
    path('table', views.Editable.as_view(),name='tables_editable'),
